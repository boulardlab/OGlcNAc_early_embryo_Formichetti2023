---
title: "TE analysis in morulae embryos injected and nonInjected w active/dead-Btgh"
date: "June 13th, 2022"
author: 
...
counts_dt <- counts_dt[, !(names(counts_dt) %in% c("mA19","mD2","mA11","mA16", "mA7", "mD20")), with = FALSE]
...
samples_table <- samples_table[!(samples_table$sample %in% c("mA19","mD2","mA11","mA16", "mA7", "mD20")), ]
...
dds <- DESeqDataSetFromMatrix(countData = counts_m[, !(colnames(counts_m) %in% c("mA9", "mA20", "mC6"))],
                              colData = design_df[!(rownames(design_df) %in% c("mA9", "mA20", "mC6")), ],
